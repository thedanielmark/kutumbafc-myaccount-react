...
class MainContent extends React.Component {
  ...
  cancelUpdatePersonalInfo() {
    ...
    document.getElementById("updatePersonalInfoButton").classList.add("d-none");
    document
      .getElementById("cancelUpdatePersonalInfoButton")
                ...
                <div className="card card--lg">
                  ...
                  <div className="card__content">
                    ...
                    <button
                      ...
                      className="btn btn-primary-inverse ml-2 d-none"
                      onClick={this.cancelUpdatePersonalInfo}
                    >
                      Cancel
                    </button>
                  </div>
